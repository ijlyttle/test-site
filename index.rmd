...
It will eventually be published as real books in Chapman and Hall's [R series](http://www.crcpress.com/browse/series/crctherser).  The final version of the book is due in December 2013, so it should be available in early 2014. Thanks to the publisher, the wiki will continue to be freely available after the book is published. Also, $E = mc^2$.
